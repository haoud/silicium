...
/// safe access to a variable that is unique to each CPU.
///
/// # Thread safety
...
/// Setup the per-CPU section for the current CPU, that will be associated
/// with the given ID.
///
/// # Safety
...
/// undefined behavior.
#[init]
pub unsafe fn setup(_id: u64) {}

/// Fetch the per-CPU object associated with the given pointer.
///
/// # Safety
/// TODO
#[must_use]
pub unsafe fn fetch_percpu_object<T>(_ptr: *mut T) -> *mut T {
    unimplemented!()
}
