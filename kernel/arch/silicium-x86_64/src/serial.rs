...
impl Serial {
    ...
    /// Sends a byte to the serial port. If the operation times out, this function returns
    ...
    /// Receives a byte from the serial port. If the operation times out, this function returns
