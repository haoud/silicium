...
const TID_BITMAP_COUNT: usize =
    MAX_TIDS as usize / core::mem::size_of::<usize>();
...
/// A thread identifier. It can only be created by the `Tid::generate` method
/// and is automatically released when it goes out of scope.
