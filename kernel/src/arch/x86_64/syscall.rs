...
///
/// # Safety
/// This function is unsafe because it assume that the `syscall_enter` function exists
/// in the kernel code, and is correctly set up to handle system calls. This function
/// should also only be called once during the kernel initialization.
#[init]
pub unsafe fn setup() {
    ...
    // The LStar MSR is used to set up the entry point for system calls. This is the
